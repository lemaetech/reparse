...
let char_exn parse () =
  ...
  Alcotest.(
    check_raises
      "char"
      (Parser { offset = 0; line_number = 0; column_number = 0; msg = "[char] 'h'" })
      r)
;;
...
let string_exn parse () =
  ...
  Alcotest.(
    check_raises
      "string"
      (Parser { offset = 0; line_number = 0; column_number = 0; msg = "[string] hello" })
      r)
;;
...
let char_if_exn parse () =
  ...
  Alcotest.(
    check_raises
      "char_if"
      (Parser { offset = 0; line_number = 0; column_number = 0; msg = "[char_if]" })
      r)
;;
